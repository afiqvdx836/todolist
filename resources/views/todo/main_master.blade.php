...
<head>
	...
	<link href="{{ asset('jobick/vendor/jquery-nice-select/css/nice-select.css') }} " rel="stylesheet">
	<link href="{{ asset('jobick/vendor/owl-carousel/owl.carousel.css')  }}" rel="stylesheet">
	
	<!-- Style css -->
    <link href="{{asset('jobick/css/style.css')}}" rel="stylesheet">
...
<body>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('jobick/vendor/global/global.min.js') }}"></script>
	<script src="{{ asset('jobick/vendor/chart.js/Chart.bundle.min.js') }}"></script>
	<script src="{{ asset('jobick/vendor/jquery-nice-select/js/jquery.nice-select.min.js') }}"></script>
	
	<!-- Apex Chart -->
	<script src="{{ asset('jobick/vendor/apexchart/apexchart.js') }}"></script>
	
	<script src="{{ asset('jobick/vendor/chart.js/Chart.bundle.min.js') }}"></script>
	
	<!-- Chart piety plugin files -->
    <script src="{{ asset('jobick/vendor/peity/jquery.peity.min.js') }}"></script>
	
	<!-- Dashboard 1 -->
	<script src="{{ asset('jobick/js/dashboard/dashboard-1.js') }}"></script>
	
	<script src="{{ asset('jobick/vendor/owl-carousel/owl.carousel.js') }}"></script>
	
    <script src="{{ asset('jobick/js/custom.min.js') }}"></script>
	<script src="{{ asset('jobick/js/dlabnav-init.js') }}"></script>
